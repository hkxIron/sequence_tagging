...
greater_mask =  
 ...
 2-2+1 =1 dim
after mask score =  
[ 0.69999999  0.2  0.40000001  0.40000001  0.30000001  0.2 0.40000001]

after valid indices =  [2 1 3 4 1 3 4]

selected bags: 
[1002 1001 1003 1004 1001 1003 1004]
...
"""
 Examples:
  ...
  boolean_mask(tensor, mask)  # [[1, 2], [5, 6]], 2-1+1=2 dim
  ```
"""
